...
*/[Protocol]
	...
	{
		// @required -(NSURLRequest * _Nullable)requestBySerializingRequest:(NSURLRequest * _Nonnull)request withParameters:(id _Nullable)parameters error:(NSError * _Nullable * _Nullable)error __attribute__((swift_error("none")));
		[Abstract]
	...
	interface AFHTTPRequestSerializer : IAFURLRequestSerialization
	{
		...
		// -(void)setQueryStringSerializationWithBlock:(NSString * _Nullable (^ _Nullable)(NSURLRequest * _Nonnull, id _Nonnull, NSError * _Nullable * _Nullable))block;
		...
		// -(NSMutableURLRequest * _Nullable)requestWithMethod:(NSString * _Nonnull)method URLString:(NSString * _Nonnull)URLString parameters:(id _Nullable)parameters error:(NSError * _Nullable * _Nullable)error;
...
*/[Protocol]
	...
	{
		// @required -(id _Nullable)responseObjectForResponse:(NSURLResponse * _Nullable)response data:(NSData * _Nullable)data error:(NSError * _Nullable * _Nullable)error __attribute__((swift_error("none")));
		[Abstract]
	...
	interface AFSecurityPolicy : INSSecureCoding, INSCopying
	{
		...
		bool EvaluateServerTrust (SecTrust serverTrust, [NullAllowed] string domain);
	}
	...
	interface AFNetworkReachabilityManager
	{
		...
		unsafe NativeHandle Constructor (SCNetworkReachabilityRef* reachability);
	...
	interface AFURLSessionManager : INSUrlSessionDelegate, INSUrlSessionTaskDelegate, INSUrlSessionDataDelegate, INSUrlSessionDownloadDelegate, INSSecureCoding, INSCopying
	{
		...
		[DesignatedInitializer]
		NativeHandle Constructor ([NullAllowed] NSUrlSessionConfiguration configuration);

		// -(void)invalidateSessionCancelingTasks:(BOOL)cancelPendingTasks resetSession:(BOOL)resetSession;
		[Export ("invalidateSessionCancelingTasks:resetSession:")]
		void InvalidateSessionCancelingTasks (bool cancelPendingTasks, bool resetSession);
		...
		// -(void)setTaskWillPerformHTTPRedirectionBlock:(NSURLRequest * _Nullable (^ _Nullable)(NSURLSession * _Nonnull, NSURLSessionTask * _Nonnull, NSURLResponse * _Nonnull, NSURLRequest * _Nonnull))block;
		...
		// -(void)setAuthenticationChallengeHandler:(id  _Nonnull (^ _Nonnull)(NSURLSession * _Nonnull, NSURLSessionTask * _Nonnull, NSURLAuthenticationChallenge * _Nonnull, void (^ _Nonnull)(NSURLSessionAuthChallengeDisposition, NSURLCredential * _Nullable)))authenticationChallengeHandler;
		[Export ("setAuthenticationChallengeHandler:")]
		void SetAuthenticationChallengeHandler (Func<NSURLSession, NSURLSessionTask, NSURLAuthenticationChallenge, Action<NSURLSessionAuthChallengeDisposition, NSURLCredential>, NSObject> authenticationChallengeHandler);
		...
		// -(void)setTaskDidFinishCollectingMetricsBlock:(void (^ _Nullable)(NSURLSession * _Nonnull, NSURLSessionTask * _Nonnull, NSURLSessionTaskMetrics * _Nullable))block __attribute__((availability(ios, introduced=10))) __attribute__((availability(macos, introduced=10.12))) __attribute__((availability(watchos, introduced=3))) __attribute__((availability(tvos, introduced=10)));
		[Watch (3,0), TV (10,0), Mac (10,12), iOS (10,0)]
		[Export ("setTaskDidFinishCollectingMetricsBlock:")]
		void SetTaskDidFinishCollectingMetricsBlock ([NullAllowed] Action<NSURLSession, NSURLSessionTask, NSURLSessionTaskMetrics> block);
		...
		// -(void)setDidFinishEventsForBackgroundURLSessionBlock:(void (^ _Nullable)(NSURLSession * _Nonnull))block __attribute__((availability(macos, unavailable)));
		[NoMac]
	...
	partial interface Constants
	{
		...
		[Field ("AFURLSessionDownloadTaskDidMoveFileSuccessfullyNotification", "__Internal")]
		NSString AFURLSessionDownloadTaskDidMoveFileSuccessfullyNotification { get; }
		...
		[Field ("AFNetworkingTaskDidCompleteSessionTaskMetrics", "__Internal")]
		NSString AFNetworkingTaskDidCompleteSessionTaskMetrics { get; }
	}
	...
	interface AFHTTPSessionManager : INSSecureCoding, INSCopying
	{
		...
		[DesignatedInitializer]
		NativeHandle Constructor ([NullAllowed] NSUrl url, [NullAllowed] NSUrlSessionConfiguration configuration);

		// -(NSURLSessionDataTask * _Nullable)GET:(NSString * _Nonnull)URLString parameters:(id _Nullable)parameters headers:(NSDictionary<NSString *,NSString *> * _Nullable)headers progress:(void (^ _Nullable)(NSProgress * _Nonnull))downloadProgress success:(void (^ _Nullable)(NSURLSessionDataTask * _Nonnull, id _Nullable))success failure:(void (^ _Nullable)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull))failure;
		[Export ("GET:parameters:headers:progress:success:failure:")]
		[return: NullAllowed]
		NSUrlSessionDataTask GET (string URLString, [NullAllowed] NSObject parameters, [NullAllowed] NSDictionary<NSString, NSString> headers, [NullAllowed] Action<NSProgress> downloadProgress, [NullAllowed] Action<NSURLSessionDataTask, NSObject> success, [NullAllowed] Action<NSURLSessionDataTask, NSError> failure);

		// -(NSURLSessionDataTask * _Nullable)HEAD:(NSString * _Nonnull)URLString parameters:(id _Nullable)parameters headers:(NSDictionary<NSString *,NSString *> * _Nullable)headers success:(void (^ _Nullable)(NSURLSessionDataTask * _Nonnull))success failure:(void (^ _Nullable)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull))failure;
		[Export ("HEAD:parameters:headers:success:failure:")]
		[return: NullAllowed]
		NSUrlSessionDataTask HEAD (string URLString, [NullAllowed] NSObject parameters, [NullAllowed] NSDictionary<NSString, NSString> headers, [NullAllowed] Action<NSURLSessionDataTask> success, [NullAllowed] Action<NSURLSessionDataTask, NSError> failure);

		// -(NSURLSessionDataTask * _Nullable)POST:(NSString * _Nonnull)URLString parameters:(id _Nullable)parameters headers:(NSDictionary<NSString *,NSString *> * _Nullable)headers progress:(void (^ _Nullable)(NSProgress * _Nonnull))uploadProgress success:(void (^ _Nullable)(NSURLSessionDataTask * _Nonnull, id _Nullable))success failure:(void (^ _Nullable)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull))failure;
		[Export ("POST:parameters:headers:progress:success:failure:")]
		[return: NullAllowed]
		NSUrlSessionDataTask POST (string URLString, [NullAllowed] NSObject parameters, [NullAllowed] NSDictionary<NSString, NSString> headers, [NullAllowed] Action<NSProgress> uploadProgress, [NullAllowed] Action<NSURLSessionDataTask, NSObject> success, [NullAllowed] Action<NSURLSessionDataTask, NSError> failure);

		// -(NSURLSessionDataTask * _Nullable)POST:(NSString * _Nonnull)URLString parameters:(id _Nullable)parameters headers:(NSDictionary<NSString *,NSString *> * _Nullable)headers constructingBodyWithBlock:(void (^ _Nullable)(id<AFMultipartFormData> _Nonnull))block progress:(void (^ _Nullable)(NSProgress * _Nonnull))uploadProgress success:(void (^ _Nullable)(NSURLSessionDataTask * _Nonnull, id _Nullable))success failure:(void (^ _Nullable)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull))failure;
		[Export ("POST:parameters:headers:constructingBodyWithBlock:progress:success:failure:")]
		[return: NullAllowed]
		NSUrlSessionDataTask POST (string URLString, [NullAllowed] NSObject parameters, [NullAllowed] NSDictionary<NSString, NSString> headers, [NullAllowed] Action<AFMultipartFormData> block, [NullAllowed] Action<NSProgress> uploadProgress, [NullAllowed] Action<NSURLSessionDataTask, NSObject> success, [NullAllowed] Action<NSURLSessionDataTask, NSError> failure);

		// -(NSURLSessionDataTask * _Nullable)PUT:(NSString * _Nonnull)URLString parameters:(id _Nullable)parameters headers:(NSDictionary<NSString *,NSString *> * _Nullable)headers success:(void (^ _Nullable)(NSURLSessionDataTask * _Nonnull, id _Nullable))success failure:(void (^ _Nullable)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull))failure;
		[Export ("PUT:parameters:headers:success:failure:")]
		[return: NullAllowed]
		NSUrlSessionDataTask PUT (string URLString, [NullAllowed] NSObject parameters, [NullAllowed] NSDictionary<NSString, NSString> headers, [NullAllowed] Action<NSURLSessionDataTask, NSObject> success, [NullAllowed] Action<NSURLSessionDataTask, NSError> failure);

		// -(NSURLSessionDataTask * _Nullable)PATCH:(NSString * _Nonnull)URLString parameters:(id _Nullable)parameters headers:(NSDictionary<NSString *,NSString *> * _Nullable)headers success:(void (^ _Nullable)(NSURLSessionDataTask * _Nonnull, id _Nullable))success failure:(void (^ _Nullable)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull))failure;
		[Export ("PATCH:parameters:headers:success:failure:")]
		[return: NullAllowed]
		NSUrlSessionDataTask PATCH (string URLString, [NullAllowed] NSObject parameters, [NullAllowed] NSDictionary<NSString, NSString> headers, [NullAllowed] Action<NSURLSessionDataTask, NSObject> success, [NullAllowed] Action<NSURLSessionDataTask, NSError> failure);

		// -(NSURLSessionDataTask * _Nullable)DELETE:(NSString * _Nonnull)URLString parameters:(id _Nullable)parameters headers:(NSDictionary<NSString *,NSString *> * _Nullable)headers success:(void (^ _Nullable)(NSURLSessionDataTask * _Nonnull, id _Nullable))success failure:(void (^ _Nullable)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull))failure;
		[Export ("DELETE:parameters:headers:success:failure:")]
		[return: NullAllowed]
		NSUrlSessionDataTask DELETE (string URLString, [NullAllowed] NSObject parameters, [NullAllowed] NSDictionary<NSString, NSString> headers, [NullAllowed] Action<NSURLSessionDataTask, NSObject> success, [NullAllowed] Action<NSURLSessionDataTask, NSError> failure);

		// -(NSURLSessionDataTask * _Nullable)dataTaskWithHTTPMethod:(NSString * _Nonnull)method URLString:(NSString * _Nonnull)URLString parameters:(id _Nullable)parameters headers:(NSDictionary<NSString *,NSString *> * _Nullable)headers uploadProgress:(void (^ _Nullable)(NSProgress * _Nonnull))uploadProgress downloadProgress:(void (^ _Nullable)(NSProgress * _Nonnull))downloadProgress success:(void (^ _Nullable)(NSURLSessionDataTask * _Nonnull, id _Nullable))success failure:(void (^ _Nullable)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull))failure;
		[Export ("dataTaskWithHTTPMethod:URLString:parameters:headers:uploadProgress:downloadProgress:success:failure:")]
		[return: NullAllowed]
		NSUrlSessionDataTask DataTaskWithHTTPMethod (string method, string URLString, [NullAllowed] NSObject parameters, [NullAllowed] NSDictionary<NSString, NSString> headers, [NullAllowed] Action<NSProgress> uploadProgress, [NullAllowed] Action<NSProgress> downloadProgress, [NullAllowed] Action<NSURLSessionDataTask, NSObject> success, [NullAllowed] Action<NSURLSessionDataTask, NSError> failure);
	}
...
*/[Protocol]
	...
	{
		// @required -(BOOL)shouldCacheImage:(UIImage * _Nonnull)image forRequest:(NSURLRequest * _Nonnull)request withAdditionalIdentifier:(NSString * _Nullable)identifier;
		[Abstract]
		[Export ("shouldCacheImage:forRequest:withAdditionalIdentifier:")]
		bool ShouldCacheImage (UIImage image, NSUrlRequest request, [NullAllowed] string identifier);
	...
	interface AFAutoPurgingImageCache : IAFImageRequestCache
	{
		...
		NativeHandle Constructor (ulong memoryCapacity, ulong preferredMemoryCapacity);
	}
	...
	interface AFImageDownloader
	{
		...
		// @property (assign, nonatomic) AFImageDownloadPrioritization downloadPrioritization;
		[Export ("downloadPrioritization", ArgumentSemantic.Assign)]
		AFImageDownloadPrioritization DownloadPrioritization { get; set; }
		...
		// +(NSURLSessionConfiguration * _Nonnull)defaultURLSessionConfiguration;
		[Static]
		[Export ("defaultURLSessionConfiguration")]
		[Verify (MethodToProperty)]
		NSUrlSessionConfiguration DefaultURLSessionConfiguration { get; }

		// -(instancetype _Nonnull)initWithSessionConfiguration:(NSURLSessionConfiguration * _Nonnull)configuration;
		[Export ("initWithSessionConfiguration:")]
		NativeHandle Constructor (NSUrlSessionConfiguration configuration);
		...
		NativeHandle Constructor (AFHTTPSessionManager sessionManager, AFImageDownloadPrioritization downloadPrioritization, nint maximumActiveDownloads, [NullAllowed] AFImageRequestCache imageCache);
	...
	// @interface AFNetworking (WKWebView)
	[Category]
	[BaseType (typeof(WKWebView))]
	interface WKWebView_AFNetworking
	{
		// @property (nonatomic, strong) AFHTTPSessionManager * _Nonnull sessionManager;
		[Export ("sessionManager", ArgumentSemantic.Strong)]
		AFHTTPSessionManager SessionManager { get; set; }

		// -(void)loadRequest:(NSURLRequest * _Nonnull)request navigation:(WKNavigation * _Nonnull)navigation progress:(NSProgress * _Nullable * _Nullable)progress success:(NSString * _Nonnull (^ _Nullable)(NSHTTPURLResponse * _Nonnull, NSString * _Nonnull))success failure:(void (^ _Nullable)(NSError * _Nonnull))failure;
		[Export ("loadRequest:navigation:progress:success:failure:")]
		void LoadRequest (NSUrlRequest request, WKNavigation navigation, [NullAllowed] out NSProgress progress, [NullAllowed] Func<NSHTTPURLResponse, NSString, NSString> success, [NullAllowed] Action<NSError> failure);

		// -(void)loadRequest:(NSURLRequest * _Nonnull)request navigation:(WKNavigation * _Nonnull)navigation MIMEType:(NSString * _Nullable)MIMEType textEncodingName:(NSString * _Nullable)textEncodingName progress:(NSProgress * _Nullable * _Nullable)progress success:(NSData * _Nonnull (^ _Nullable)(NSHTTPURLResponse * _Nonnull, NSData * _Nonnull))success failure:(void (^ _Nullable)(NSError * _Nonnull))failure;
		[Export ("loadRequest:navigation:MIMEType:textEncodingName:progress:success:failure:")]
		void LoadRequest (NSUrlRequest request, WKNavigation navigation, [NullAllowed] string MIMEType, [NullAllowed] string textEncodingName, [NullAllowed] out NSProgress progress, [NullAllowed] Func<NSHTTPURLResponse, NSData, NSData> success, [NullAllowed] Action<NSError> failure);
	}
}
