...
namespace io.freestarAds.iOS
{
	static class CFunctions
	{
		...
		// extern id _Nonnull AFJSONObjectByRemovingKeysWithNullValues (id _Nonnull JSONObject, NSJSONReadingOptions readingOptions);
		[DllImport ("__Internal")]
		[Verify (PlatformInvoke)]
		static extern NSObject AFJSONObjectByRemovingKeysWithNullValues (NSObject JSONObject, NSJSONReadingOptions readingOptions);
